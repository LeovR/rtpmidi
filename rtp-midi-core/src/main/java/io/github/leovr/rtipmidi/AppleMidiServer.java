...
/**
 * Main class for the RTP MIDI communication. This class instantiates the {@link AppleMidiControlServer} and the {@link AppleMidiSessionServer}. In order to receive midi messages a
 * {@link AppleMidiSession} should be registerd via {@link #addAppleMidiSession(AppleMidiSession)}.
 */
@Slf4j
